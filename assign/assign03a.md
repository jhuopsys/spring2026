...
**Due:** Friday, April 13th by 11 pm
...
[Accessing User Memory](assign02.html#3-accessing-user-memory) in project 2) while
...
The submission process is essentially the same as Assignments 1 and 2:
...
5. Upload the resulting zipfile to Gradescope as "Assignment 3a"
...
cd $REPODIR
curl -O https://jhuopsys.github.io/spring2025/assign/create_submission_a3a.sh
chmod a+x create_submission_a3a.sh
./create_submission_a3a.sh
</pre></div>
